...
@Component({
  selector: 'go-export-receipt-returns',
  standalone: true,
  imports: [
  ...
  templateUrl: './go_export_receipt_returns.component.html',
  styleUrl: './go_export_receipt_returns.component.css'
 
})
export class GoExportReceiptReturnsComponent implements OnInit,AfterViewInit {
...
displayedColumns: string[] = 
    ...
    ngAfterViewInit() {     
        ...
        .pipe(
          ...
          switchMap(() => {
            ...
            return this.dataService!.getPODetailsFromFleet4ReceiptReturnsXport(
  ...
  onSubmit() {
    ...
    if (this.lpoPostingForm.valid) {
      ...
      this.subPostLPO = this.dataService.postReceiptReturns2GRP(this.post_lpo_request).subscribe((resp)=>{


        this.spinner.hide();
       
        this.dataService.appMessageDialogContent.set(`The receipit returns LPO# ${this.LpoRef} has been exported to GRP successfully, export refererence is # ${resp.ReferenceNo.toString()} `);
